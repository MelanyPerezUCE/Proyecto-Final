...
import { guardarDespachoTemporal } from "@/firebase/database";
import {
  buildDespachoDTO,
...
export default function DespachoScreen() {
  ...
  const onSubmitDispatch = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Error",
        "No se pudo guardar el despacho. Intenta nuevamente.",
      );
    }
  };
        ...
        >
          <View style={styles.sectionHeaderRow}>
            ...
            <View style={[styles.statusBadge, { borderColor: badgeBorder }]}>
              ...
              />
              <Text
                style={[styles.statusText, { color: badgeText, marginLeft: 6 }]}
              >
                Subsidiado
              </Text>
            </View>
          ...
          >
            <View style={styles.subsidyLeft}>
              ...
              <View style={styles.subsidyOkRow}>
                ...
                <Text style={[styles.subsidyOkText, { color: colors.tint }]}>
                  Recarga Autorizada
                </Text>
              </View>
            </View>
