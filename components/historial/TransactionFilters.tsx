...
export default function TransactionFilters({ onFilter }: Props) {
  ...
  return (
    <View>
      ...
      >
        {/* CAMBIO 2: Mostramos el texto condicionalmente */}
        <Text style={{ color: startDate ? textColor : "#999" }}>
      ...
      <View style={styles.rowContainer}>
        <View style={{ flex: 1, marginRight: 10 }}>
          ...
          >
            <Text style={{ color: endDate ? textColor : "#999" }}>
              {formatDate(endDate)}
            </Text>
            <MaterialIcons name="event" size={18} color={labelColor} />
          </TouchableOpacity>
        ...
        <TouchableOpacity
          style={[styles.filterBtn, { backgroundColor: buttonBg }]}
